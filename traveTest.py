...
sys.path.append('BestHotelDeal.py')
from travel import *
...
class TestTravel(unittest.TestCase):
    ...
    def test3Rbt(self):
        ...
        tripArgs = parseInput (trip)
        answer = manager.BestDeal(tripArgs[0],tripArgs[1],tripArgs[2])
        self.assertEqual(answer, ('*', 'nodeals'))

    def testNoDeals(self):
        self.cols()
        to_db = [['e', '250', 'rebate_3plus', '-50', 'rebate_3plus', '2016-03-01', '2016-03-31'],
                            ['e', '250', 'pct', '-5', 'pct', '2016-03-01', '2016-03-15'],
                            ['e', '250', 'rebate', '-20', 'rebate', '2016-03-07', '2016-03-15']]
        manager = DealManager(enableCache = True)
        manager.insertData(self.columns,to_db)
